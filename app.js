...
app.get('/api/columnasxtipousuario/:idTipoUsuario', ColumnasxTipoUsuario.getColumnasByIDTipoUsuario);
app.get('/api/columnasxusuario/:idUsuario', ColumnasxUsuario.getColumnasByIDUsuario);

app.get('/api/elementosxtipousuario/:idTipoUsuario', ElementosxTipoUsuario.getElementosByIDTipoUsuario);
app.get('/api/elementosxusuario/:idUsuario', ElementosxUsuario.getElementosByIDUsuario);
